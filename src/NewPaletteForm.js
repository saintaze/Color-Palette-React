...
export default function NewPaletteForm() {
  ...
  const addNewColor = () => setColors([...colors, selectedColor])
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Button onClick={addNewColor} variant='contained' style={{backgroundColor: selectedColor}} disableElevation>Add Color</Button>
      </Drawer>
      <main
      ...
      >
      <div className={classes.drawerHeader} />
      {colors.map(c => <div style={{backgroundColor: c}}>{c}</div>)}
      </main>
  </div>
  );
}
